...
export function renderSearchFood(data: { foods: Food[] }) {
  const leftContainerItems = document.getElementById(
    'leftContainerItems'
  ) as HTMLElement;
  const elem = data.foods[0];
            ...
            <div class="calculator_item_main">
                ...
                <img class="photo_image" src="${
                  elem.photo.thumb
                    ...
                    <p id="containerItemFoodName">${ucFirst(elem.food_name)}</p>
                </div>
                ...
                <div class="item_container_calculator disabled" id="item_container_calculator">
                    ...
                    <div class="item_container_nutrients">
                        <div class="kcal">
                            kcal
                            <p id="containerItemKcal">${elem.nf_calories}</p>
                        </div>
                        <div class="containerItemNutrient">
                            Protein
                            <p id="containerItemProtein">${elem.nf_protein}</p>
                        </div>
                        <div class="containerItemNutrient">
                            Fat
                            <p id="containerItemFat">${elem.nf_total_fat}</p>
                        </div>
                        <div class="containerItemNutrient">
                            Carbohydrate
                            <p id="containerItemCarbohydrate">${
                              elem.nf_total_carbohydrate
                            }</p>
                        </div>
                    </div>
                </div>
